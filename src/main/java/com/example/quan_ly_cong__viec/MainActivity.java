...
public class MainActivity extends AppCompatActivity{
    ...
    //khai bao arrJob de luu tru cong viec
    ArrayList<phamDuyThanh>arrJob=new ArrayList<phamDuyThanh>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter <phamDuyThanh> adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    //ham de load cac control theo id
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<phamDuyThanh>(this,android.R.layout.simple_list_item_1,
                        arrJob);
    ...
    // ham gan cac su kien cho control
    ...
    // hien thi cac DatePicker dialog
    ...
    public void processAddJob()
    {
        ...
        phamDuyThanh job=new phamDuyThanh(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
